...
ArmFeaturesUniquePtr ArmInstructionSetFeatures::FromVariant(
  ...
  static const char* arm_variants_with_div[] = {
          ...
          "cortex-a53.a57", "cortex-a72", "cortex-a73", "cortex-m3", "cortex-m4", "cortex-r4", "cortex-r5",
  ...
  static const char* arm_variants_with_lpae[] = {
      "cortex-a7", "cortex-a15", "krait", "denver", "cortex-a53", "cortex-a57", "cortex-a53.a57", "cortex-a72", "cortex-a73"
  };
